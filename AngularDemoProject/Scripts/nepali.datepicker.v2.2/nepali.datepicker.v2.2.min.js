...
function setSelectedDay(t) {
	...
	$("#" + e).data('target') && $("#" + $("#" + e).data('target') ).val(BS2AD(t)).trigger('change');
	...
	function (t) {
		t.fn.nepaliDatePicker = function (e) {
			e = void 0 !== e ? e : {}, ndpAttr = e, this.each(function () {
				...
				if (!n) { console.log('Nepali Date Picker must have id.'); }
				//if (t(this).data('target')) { e['ndpEnglishInput'] = t(this).data('target'); }
