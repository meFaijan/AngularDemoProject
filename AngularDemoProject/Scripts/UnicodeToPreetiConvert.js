function unicode2preeti(unicode_text_id,data_target_id) {
    ...
    var modified_substring = document.getElementById(unicode_text_id).value;
    Replace_Symbols();
    processed_text = modified_substring;
    document.getElementById(data_target_id).value = processed_text;
